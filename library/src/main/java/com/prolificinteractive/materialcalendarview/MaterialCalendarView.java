...
public class MaterialCalendarView extends ViewGroup {
  ...
  private int maxSelectedCountOfDays = -1;
   ...
   */
  public void setMaxSelectedCountOfDays(int countOfDays){
    this.maxSelectedCountOfDays=countOfDays;
  }

  public int getMaxSelectedCountOfDays() {
    return maxSelectedCountOfDays;
  }
